...
%RETIRAR \include{agradecimentos}

%RETIRAR \clearpage{\thispagestyle{empty}\cleardoublepage}
...
\mainmatter
\acresetall
%RETIRAR \include{introducao}
%RETIRAR \clearpage{\thispagestyle{empty}\cleardoublepage}
\include{capitulo-2}
\clearpage{\thispagestyle{empty}\cleardoublepage}
%RETIRAR \include{capitulo-3}
%RETIRAR \clearpage{\thispagestyle{empty}\cleardoublepage}
%RETIRAR \include{capitulo-4}
%RETIRAR \clearpage{\thispagestyle{empty}\cleardoublepage}
%RETIRAR \include{conc-trab-futuro}
%RETIRAR \clearpage{\thispagestyle{empty}\cleardoublepage}
